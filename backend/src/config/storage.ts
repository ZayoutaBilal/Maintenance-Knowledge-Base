import type {InsertProblem, InsertUser, Problem, ProblemFilter, SafeUser, UpdateProblem, User} from "../models/schema";
import {problems, users} from "../models/schema";
import {and, arrayContains, desc, eq, gte, lte, or, sql} from "drizzle-orm";
